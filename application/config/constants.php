...
defined('HTTP_PERMANENT_REDIRECT') OR define('HTTP_PERMANENT_REDIRECT', 308);
...
defined('HTTP_PAYLOAD_TOO_LARGE') OR define('HTTP_PAYLOAD_TOO_LARGE', 413);
defined('HTTP_URI_TOO_LONG') OR define('HTTP_URI_TOO_LONG', 414);
defined('HTTP_UNSUPPORTED_MEDIA_TYPE') OR define('HTTP_UNSUPPORTED_MEDIA_TYPE', 415);
defined('HTTP_RANGE_NOT_SATISFIABLE') OR define('HTTP_RANGE_NOT_SATISFIABLE', 416);
defined('HTTP_EXPECTATION_FAILED') OR define('HTTP_EXPECTATION_FAILED', 417);
defined('HTTP_IM_A_TEAPOT') OR define('HTTP_IM_A_TEAPOT', 418);
defined('HTTP_MISDIRECTED_REQUEST') OR define('HTTP_MISDIRECTED_REQUEST', 421);
defined('HTTP_UNPROCESSABLE_REQUEST') OR define('HTTP_UNPROCESSABLE_REQUEST', 422);
defined('HTTP_LOCKED') OR define('HTTP_LOCKED', 423);
defined('HTTP_FAILED_DEPENDENCY') OR define('HTTP_FAILED_DEPENDENCY', 424);
defined('HTTP_TOO_EARLY') OR define('HTTP_TOO_EARLY', 425);
...
defined('HTTP_TOO_MANY_REQUEST') OR define('HTTP_TOO_MANY_REQUEST', 429);
defined('HTTP_REQUEST_HEADER_FIELDS_TOO_LARGE') OR define('HTTP_REQUEST_HEADER_FIELDS_TOO_LARGE', 431);
defined('HTTP_UNAVAILABLE_FOR_LEGAL_REASON') OR define('HTTP_UNAVAILABLE_FOR_LEGAL_REASON', 451);
...
defined('HTTP_VARIANT_ALSO_NEGOTIATE') OR define('HTTP_VARIANT_ALSO_NEGOTIATE', 506);
defined('HTTP_INSUFFICENT_STORAGE') OR define('HTTP_INSUFFICENT_STORAGE', 507);
